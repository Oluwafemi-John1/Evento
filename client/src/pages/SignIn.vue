    ...
    <div class="signin-container">
      <div class="signin-card">
        ...
        <div class="signin-header">
          ...
          <p class="signin-subtitle">Sign in to continue managing your events</p>
        </div>
        ...
        <div class="signin-footer">
          <p>Don't have an account? <router-link to="/createaccount" class="signup-link">Create Account</router-link>
          </p>
        </div>
      </div>
    </div>
...
const handleSignin = () => {
  ...
  console.log('Signin data:', formData.value)
  // router.push('/')
}
</script>
...
.stars2 {
  background-image: radial-gradient(1px 1px at 100px 120px, white, rgba(0, 0, 0, 0)),
...
.stars3 {
  background-image: radial-gradient(1px 1px at 10px 60px, white, rgba(0, 0, 0, 0)),
